...
At the end of last year, we decided on a new process for updating our [advance decision form](https://compassionindying.org.uk/how-we-can-help/living-will-advance-decision/).
...
We had some helpful sessions with [Caroline Jarret (a forms expert)](https://www.effortmark.co.uk/) who helped us design a new process. 
...
1. It's important to recognise our bandwidth - what do we genuinely have capacity to work on?
2. Don't hesitate to fix the small stuff
3. Factor in cost of changes - both print and software development costs
4. Big policy/practice issues with advance decisions aren't worsened by better quality inputs into the form
5. We need to think about how we communicate changes to users and organisations who use our form
6. How to define a 'breaking change'... or better put a 'destroy old stock' change to the form
